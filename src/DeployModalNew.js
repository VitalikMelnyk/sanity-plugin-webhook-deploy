...
import {useToast, Box, Stack, Button, Spinner, Dialog, TextInput, Label} from '@sanity/ui'
...
const DeployModalNew = ({onClose}) => {
  ...
  const isFormDisabled = !pendingHook.title || !pendingHook.url || !pendingHook.statusBadgeUrl
  ...
  return (
    <Dialog width={1} header="New Netlify Enviroment" onClose={onCloseNewModal}>
      <Box padding={4}>
